...
const Header = () => {
    ...
    return (
        <div 
            ...
            <Link className={`text-white text-nowrap no-underline duration-300 hover:bg-__brown py-[13px] ps-[32px] pe-[16px] ${!pathname?.includes('about-us') && !pathname?.includes('search') ? 'bg-__brown': ''}`} to={'/'}>{t("NavHome")}</Link>
