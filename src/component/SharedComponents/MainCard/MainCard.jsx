...
const MainCard = ( { pictures, name, daylyPrice, monthlyPrice, weeklyPrice } ) => {
        ...
        <div>
            <div className="bg-white w-full border-[1px] border-solid border-__brown rounded-[15px] overflow-hidden">
                ...
                <div className="flex flex-wrap justify-center items-start gap-[2px]">
                    ...
                    <Link to={'#'} className="flex flex-[30%] py-[5px] justify-center items-center gap-[4px] text-white bg-__brown no-underline duration-300 hover:translate-y-[10%] "><FaPhone/>Call us</Link>
                    <Link to={'#'} className="flex flex-[30%] py-[5px] justify-center items-center gap-[4px] text-white bg-__brown no-underline duration-300 hover:translate-y-[10%] "><FaCalendar/>Book now</Link>
                </div>
            </div>
        </div>
    )
